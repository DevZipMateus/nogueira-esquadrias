...
const NogueiraServices = () => {
  ...
  return (
    <section ref={sectionRef} id="servicos" className="py-12 sm:py-16 md:py-20 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <CardContent className="p-6 sm:p-8 h-full flex flex-col">
                <div className="mb-6 flex-1">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                    {service.icon}
                  </div>
        ...
        {/* Featured Services */}
        <div className={`bg-gradient-subtle rounded-2xl p-6 sm:p-8 lg:p-12 text-center ${isVisible ? 'animate-slide-in' : 'opacity-0'}`}>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6 sm:mb-8 max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className="bg-white p-3 sm:p-4 rounded-lg shadow-subtle">
          ...
          <Button
            ...
            className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-white px-6 sm:px-8 py-4 sm:py-6 text-sm sm:text-base lg:text-lg font-semibold rounded-xl shadow-elevation hover:shadow-lg transition-all duration-300 group"
            aria-label="Solicitar orçamento personalizado via WhatsApp"
          >
            <Phone className="mr-2 h-4 w-4 sm:h-5 sm:w-5" />
            <span className="hidden xs:inline">Solicite seu Orçamento Personalizado</span>
            <span className="xs:hidden">Solicitar Orçamento</span>
          </Button>
        </div>
      </div>
    </section>
